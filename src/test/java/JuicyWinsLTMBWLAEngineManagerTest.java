...
public class JuicyWinsLTMBWLAEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(JuicyWinsLTMBWLAEngineManagerTest.class);
		logger.setLevel(Level.DEBUG);
		gameParams = XMLUtil.parseResource("paymodel/JuicyWinsLTMBWLAIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/JuicyWinsLTMBWLAIW/InitOutcome.xml").getDocumentElement();
